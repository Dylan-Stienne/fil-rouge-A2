...
class CreateSurveyModel extends Database
{
     ...
     */
    public function createSurvey($title, $category, $endDate, $answers)
    {
        ...
        $this->prepare("INSERT INTO `surveys` (`title`, `category`, `author_id`, `end_date`) VALUES (:title, :category, :authorPid, :endDate)", $datas);
